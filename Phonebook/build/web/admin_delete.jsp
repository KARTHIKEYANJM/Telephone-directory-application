...
if(request.getAttribute("Message2")!=null){
    delete2 = (String)request.getAttribute("Message2");
}
if(delete2!=null){
%>
<div class="alert">
  <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
  <strong><%out.println(delete2);%></strong>             
</div>
<% }%>
    <div class="container" id="container">
	<div class="form-container sign-in-container">
            <form action="admin_delete" method="get">
                
			<h1>Delete</h1>
			<span>-----------------------------------------</span>
                        <span><b>Please enter phone number to proceed</b></span>
                        <span>-----------------------------------------</span>

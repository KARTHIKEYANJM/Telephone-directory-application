...
<%String success = null;
if(request.getAttribute("Successinsert")!=null){
    success = (String)request.getAttribute("Successinsert");
}
if(success!=null){
%>
<div class="alert1">
  <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
  <strong><%out.println(success);%></strong>             
</div>
<% }%>

<%String error = null;
if(request.getAttribute("Failinsert")!=null){
    error = (String)request.getAttribute("Failinsert");
}
if(error!=null){
%>
<div class="alert">
...
<% }%>
	...
	<div class="form-container sign-in-container">
            <form action="admin_insert" method="get">
                
			<h1>Insert</h1>
			<span>-----------------------------------------</span>
                        <span><b>Please enter data for insertion</b></span>
                        <span>-----------------------------------------</span>
			...
			<a href="admin_valid_success.jsp"><b>Want to go back?</b></a>
